  ...
  return (
    ...
    >
      ...
      <div className="p-5 md:p-6">
        ...
        <p className="text-stone-gray text-sm font-sans mb-3">
          {project.configuration}
        </p>

        <div className="mb-4">
          <p className="text-champagne-gold font-sans font-semibold text-lg">
            {project.price}
          </p>

          <p className="text-muted-gray text-xs font-sans">
            Onwards | Possession: {project.possession}
          </p>
        </div>
